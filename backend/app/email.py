...
def _welcome_content(name: str) -> tuple[str, str]:
    ...
    text = (
        f"Hi {first},\n\n"
        "Welcome to StarFeeds — the place to share startup ideas, get feedback, "
      ...
      <tr><td align="center">
        <table role="presentation" width="480" cellpadding="0" cellspacing="0"
          ...
          <tr><td style="padding:32px 40px 8px;">
            <div style="font-size:22px;font-weight:bold;color:#4d0bc0;letter-spacing:-0.5px;">StarFeeds</div>
          </td></tr>
          <tr><td style="padding:8px 40px 0;">
            <h1 style="margin:0 0 12px;font-size:24px;color:#111114;">Welcome, {first} 👋</h1>
            <p style="margin:0 0 16px;font-size:15px;line-height:1.6;color:#3f3f46;">
              You're in. StarFeeds is where you share startup ideas, get real feedback,
              and find people to build with.
            </p>
          ...
          <tr><td style="padding:28px 40px 32px;">
            <p style="margin:0;font-size:12px;color:#9a9aa2;">
              You received this because you signed up for StarFeeds.
            </p>
          </td></tr>
        </table>
      </td></tr>
...
async def send_welcome_email(to: str, name: str) -> None:
    ...
    await send_email(to, "Welcome to StarFeeds 🚀", html, text)
